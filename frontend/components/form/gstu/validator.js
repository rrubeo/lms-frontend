...
async function validateForm(formData) {
  ...
  switch (id) {
    case cfg.FRM_PBASE_STEP_0:
      break;
    case cfg.FRM_PBASE_STEP_1:
      data = {
    ...
    case cfg.FRM_PBASE_STEP_5:
      ...
      schema = yup.object().shape({
        ...
        durata: yup.number().typeError("Inserire la durata in minuti").moreThan(0, "Inserire un valore maggiore di zero").required("Inserire un valore per Durata."),
      });
      break;
  }
  let vres = {};
