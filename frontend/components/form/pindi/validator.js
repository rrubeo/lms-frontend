...
async function validateForm(formData) {
  ...
  switch (id) {
    case pi_cfg.FRM_PBASE_STEP_0:
      break;
    case pi_cfg.FRM_PBASE_STEP_1:
      data = {
